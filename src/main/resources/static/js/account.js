...
async function getUserInfo () {
    ...
    console.log('Sending request to:', 'http://localhost:8080/users/user-info');

    const response = await fetch("http://localhost:8080/users/user-info", {
        method: "POST",
        headers: {
...
async function maxLimitCards () {
    try {
        const response = await fetch ('http://localhost:8080/Cards/Accounts', {
            method: 'GET',
            headers: {
...
document.getElementById('cardCreation').addEventListener('submit', async function (e) {
    ...
    console.log("Sending Data: ", newCard, 'http://localhost:8080/Cards/CreateAccount');

    fetch ('http://localhost:8080/Cards/CreateAccount', {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json'
        },
...
document.getElementById("deletingForm").addEventListener("submit", function(event) {
    ...
    if (selectedAccount) {
        ...
        fetch (`http://localhost:8080/Cards/Accounts/${userID}`, {
...
document.getElementById("changeDetails").addEventListener("submit", function(event){
    ...
    fetch (`http://localhost:8080/Cards/Accounts/${accountData.id}`, {
        method: 'PUT',
        headers: {
            'Content-Type': 'application/json'
        },
    ...
    if (senderData.id == receiverData.id) {
        ...
        try {
            ...
            const [senderResponse, receiverResponse] = await Promise.all ([
                fetch(`http://localhost:8080/Cards/Accounts/${senderData.id}`, {
                    method: 'GET',
                    headers
                }),
                fetch(`http://localhost:8080/Cards/Accounts/${receiverData.id}`, {
                    method: 'GET',
                    headers
                })
            ]);
            ...
            const [sendingResponse, receivingResponse] = await Promise.all ([
                fetch(`http://localhost:8080/Cards/Accounts/Pay/${senderData.id}`, {
                    method: 'PUT',
                    headers: {
                        'Content-Type': 'application/json',
                ...
                fetch(`http://localhost:8080/Cards/Accounts/Pay/${receiverData.id}`, {
                    method: 'PUT',
                    headers: {
                        'Content-Type': 'application/json',
...
document.getElementById("payingForm").addEventListener("submit", async function (event) {
    ...
    if (payerData.accountBalance + sendAmnt < 0) {
        ...
        const receiverStatus = await fetch(`http://localhost:8080/Cards/Accounts/CheckExists/${payeeId}`, {
            method: 'GET',
            headers: {
                'Content-Type':'application/json'
            }
        ...
        const [sendingResponse, receivingResponse] = await Promise.all ([
            fetch(`http://localhost:8080/Cards/Accounts/Pay/${payerData.id}`, {
                method: 'PUT',
                headers: {
                    'Content-Type': 'application/json',
                    'Amount': `${sendAmnt}`
            ...
            fetch(`http://localhost:8080/Cards/Accounts/Pay/${payeeId}`, {
                method: 'PUT',
                headers: {
                    'Content-Type': 'application/json',
...
document.getElementById("depositForm").addEventListener("submit", async function (event) {
    ...
    if (enteredPin.toString().length != 4) {
        ...
        const depositStatus = await fetch(`http://localhost:8080/Cards/Accounts/Pay/${accountData.id}`, {
            method: 'PUT',
            headers: {
                'Content-Type': 'application/json',
